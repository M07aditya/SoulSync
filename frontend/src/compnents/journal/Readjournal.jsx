...
const Readjournal = () => {
    ...
    useEffect(() => {
        const fetchJournals = async () => {
            try {
                const response = await axios.get(`soul-sync-rouge.vercel.app/${username}/journals`);
    ...
    const confirmDelete = async () => {
        try {
            await axios.delete(`soul-sync-rouge.vercel.app/journal-delete/${username}/${journalToDelete}`);

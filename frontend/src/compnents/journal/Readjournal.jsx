...
const Readjournal = () => {
    ...
    useEffect(() => {
        const fetchJournals = async () => {
            try {
                const response = await axios.get(`https://soulsync-plkm.onrender.com/${username}/journals`);
    ...
    const confirmDelete = async () => {
        try {
            await axios.delete(`https://soulsync-plkm.onrender.com/journal-delete/${username}/${journalToDelete}`);

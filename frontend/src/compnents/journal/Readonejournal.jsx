...
const JournalDetail = () => {
    ...
    useEffect(() => {
        const fetchJournal = async () => {
            try {
                const response = await axios.get(`https://soulsync-1.onrender.com/${id}`);
    ...
    const coverImage = journal.coverPicture ? `https://soulsync-1.onrender.com/${CoverImage}` : defaultCoverImage;

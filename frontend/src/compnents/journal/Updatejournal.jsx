...
//             try {
//                 const response = await axios.get(`https://soulsync-1.onrender.com/${username}/${id}`);
...
// const response = await axios.put(`https://soulsync-1.onrender.com/journals/${username}/${id}`, formDataObject);

...
//             try {
//                 const response = await axios.get(`https://soulsyncs.onrender.com/${username}/${id}`);
...
// const response = await axios.put(`https://soulsyncs.onrender.com/journals/${username}/${id}`, formDataObject);

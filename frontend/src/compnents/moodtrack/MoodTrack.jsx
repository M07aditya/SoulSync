...
const MoodTrack = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://soulsync-plkm.onrender.com/api/moods/${username}`)
  ...
  const handleMoodSelect = (selectedMood) => {
    ...
    axios.post(`https://soulsync-plkm.onrender.com/api/moods/${username}`, { date: selectedDate, mood: selectedMood })
      .then(response => {

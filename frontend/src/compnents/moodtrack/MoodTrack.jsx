...
const MoodTrack = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://soulsyncs.onrender.com/api/moods/${username}`)
  ...
  const handleMoodSelect = (selectedMood) => {
    ...
    axios.post(`https://soulsyncs.onrender.com/api/moods/${username}`, { date: selectedDate, mood: selectedMood })
      .then(response => {

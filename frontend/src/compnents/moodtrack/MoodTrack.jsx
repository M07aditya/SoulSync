...
const MoodTrack = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://lucky-alpaca-6ef4e5.netlify.app/api/moods/${username}`)
  ...
  const handleMoodSelect = (selectedMood) => {
    ...
    axios.post(`https://lucky-alpaca-6ef4e5.netlify.app/api/moods/${username}`, { date: selectedDate, mood: selectedMood })
      .then(response => {

...
const MoodTrack = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://soulsync-1.onrender.com/api/moods/${username}`)
  ...
  const handleMoodSelect = (selectedMood) => {
    ...
    axios.post(`https://soulsync-1.onrender.com/api/moods/${username}`, { date: selectedDate, mood: selectedMood })
      .then(response => {

...
const Navbar = () => {
  ...
  const confirmDelete = async () => {
    try {
      ...
      await fetch(`https://lucky-alpaca-6ef4e5.netlify.app/delete-user/${user}`, {
        method: 'DELETE',
      });
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            ...
            <a href="/aboutus" className="text-sm font-semibold leading-6 text-gray-900">About me</a>
          </div>
              ...
              <div className="mt-6 flow-root">
                <div className="-my-6 divide-y divide-gray-500/10">
                  <div className="space-y-2 py-6">
                    ...
                    <a href="/aboutus" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">About me</a>
                  </div>
                  <div className="py-6">
                    {isLoggedIn ? (

...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const fetchUserDetails = async () => {
      try {
        const response = await axios.get(`soul-sync-rouge.vercel.app/${username}/getuserdetails`);
                ...
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                    <div className="relative">
                      <img
                        alt="Profile"
                        src={userDetails.profilePicture ? `soul-sync-rouge.vercel.app/${userDetails.profilePicture}` : defaultProfilePicture}

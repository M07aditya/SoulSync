...
//             try {
//                 const response = await fetch(`soul-sync-rouge.vercel.app/${username}/getuserdetails`);
...
//             const response = await axios.patch(`soul-sync-rouge.vercel.app/${username}/update-user`, formData, { headers: { 'Content-Type': 'application/json'}});

...
//             try {
//                 const response = await fetch(`https://soulsyncs.onrender.com/${username}/getuserdetails`);
...
//             const response = await axios.patch(`https://soulsyncs.onrender.com/${username}/update-user`, formData, { headers: { 'Content-Type': 'application/json'}});

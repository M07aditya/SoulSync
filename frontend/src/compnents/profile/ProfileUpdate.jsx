...
//             try {
//                 const response = await fetch(`https://soulsync-1.onrender.com/${username}/getuserdetails`);
...
//             const response = await axios.patch(`https://soulsync-1.onrender.com/${username}/update-user`, formData, { headers: { 'Content-Type': 'application/json'}});
